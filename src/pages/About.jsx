          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="card-body text-center">
                ...
                <p>Continuously expanding my knowledge and staying updated with the latest technologies.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="card-body text-center">
                ...
                <p>Always looking for creative solutions and new ways to solve problems.</p>
              </div>
            </motion.div>
          </div>
        </motion.section>
          ...
          <div className="relative">
            ...
            {timelineItems.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                // Simplified for a consistent mobile-first timeline
              ...
              >
                ...
                <div className="flex-1 ml-12 md:ml-0 md:w-1/2 md:pr-12 data-[side=right]:text-right data-[side=right]:pr-0 data-[side=right]:pl-12" data-side={index % 2 === 0 ? 'left' : 'right'}>
